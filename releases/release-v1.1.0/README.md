...
A Manifest V3 Chrome extension that shows the approx. total cost — **item price + sales tax on the item + shipping** — as a dashed-purple "Est. total" box on eBay pages, so you can compare total cost across listings at a glance. This v1.0.0 release ships two features: the **Estimated Total Calculator** and **Auction Ending Notifications**.
